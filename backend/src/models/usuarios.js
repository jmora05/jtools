...
// RELACIONES  ← antes estaba vacío
Usuarios.associate = (models) => {
  // Un usuario tiene un cliente vinculado por email (vínculo lógico, sin FK física)
  Usuarios.hasOne(models.Clientes, {
    foreignKey:  'email',
    sourceKey:   'email',
    as:          'cliente',
    constraints: false,   // sin FOREIGN KEY en BD, solo JOIN lógico
  });
